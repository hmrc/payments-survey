...
error.pageNotFound.title = Heb ddod o hyd i’r tudalen
...
survey.privacy.notice.linktext = Hysbysiad Preifatrwydd CThEM
survey.instruction.text.2.2 = i gael gwybod sut yr ydym yn casglu, defnyddio a diogelu’ch gwybodaeth bersonol.
survey.instruction.text.3 = Mae’r arolwg yn cymryd tua 1 munud i’w lenwi. Mae 4 cwestiwn ac maent i gyd yn ddewisol.
survey.nothanks.return-to-govuk = Dim diolch
...
survey.wereYouAble.response.1 = Oeddwn
survey.wereYouAble.response.0 = Nac oeddwn
# question 2
...
thanks.heading = Diolch
thanks.message = Bydd eich atebion yn ein helpu i wella''r gwasanaeth talu.
